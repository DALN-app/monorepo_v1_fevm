...
// File @openzeppelin/contracts-upgradeable/token/ERC721/utils/ERC721HolderUpgradeable.sol@v4.8.1
...
// File @tableland/evm/contracts/ITablelandController.sol@v4.0.0
...
// File @tableland/evm/contracts/ITablelandTables.sol@v4.0.0
...
// File @tableland/evm/contracts/utils/SQLHelpers.sol@v4.0.0
...
// File contracts/BasicFEVMDALN.sol
...
contract Basic_FEVM_DALN is ERC721, ERC721Enumerable, AccessControl {
  ...
  function getTokenInfo(uint256 tokenId) public view returns (TokenInfo memory) {
    require(_exists(tokenId), "Token does not exist");
    require(
      hasRole(DEFAULT_ADMIN_ROLE, _msgSender()) || _msgSender() == _tokenInfos[tokenId].owner,
...
// File @openzeppelin/contracts-upgradeable/utils/Base64Upgradeable.sol@v4.8.1
